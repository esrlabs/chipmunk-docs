...
First, the component of the popup has to be defined:
...
Create the main component of the plugin.
 ...
 */
export declare abstract class ARowCommonParser {
    /**
...
`./lib/component.ts - Typescript, Angular`
```ts
import { Component, Input } from '@angular/core';
import * as Toolkit from 'chipmunk.client.toolkit';
...
`./lib/template.html - HTML`
```html
<p>Example</p>                                                                          <!-- Example text for plugin -->
```

`./lib/row/row.colmuns_api.ts - Typescript`
```ts
import * as Toolkit from 'chipmunk.client.toolkit';
...
`./lib/row/row.columns.ts - Typescript`
```ts
import * as Toolkit from 'chipmunk.client.toolkit';
...
`./lib/row/render_api.ts - Typescript`
```ts
...
`./lib/row/component.ts - Typescript, Angular`
```ts
...
`client.plugins/example_plugin/service.ts - Typescript`
```ts
import * as Toolkit from 'chipmunk.client.toolkit';
...
`sandbox/example_plugin/main.ts - Typescript`
```typescript
